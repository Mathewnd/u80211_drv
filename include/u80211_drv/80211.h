...
#define U80211_DRV_80211_FRAME_TO_DS (1u << 8)
...
static inline const uint8_t *u80211_drv_80211_destination_address(const void *frame, uint16_t frame_control) {
	const uint8_t *frame_bytes = frame;
	uint8_t frame_type = u80211_drv_80211_frame_type(frame_control);
	if (frame_type == U80211_DRV_80211_FRAME_TYPE_DATA && (frame_control & U80211_DRV_80211_FRAME_TO_DS) != 0)
